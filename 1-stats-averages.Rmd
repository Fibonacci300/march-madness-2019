...
Read in the data
```{r}
reg_season_stats <- read.csv("data/MRegularSeasonDetailedResults.csv", stringsAsFactors = FALSE)
tourney_stats <- read.csv("data/MNCAATourneyDetailedResults.csv", stringsAsFactors = FALSE)
